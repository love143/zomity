...
function elos_preprocess_html(&$variables) {
...
// Add css skin
$setting_skin = theme_get_setting('built_in_skins', 'elos');
...
function elos_form_comment_form_alter(&$form, &$form_state) {
  $form['comment_body']['#after_build'][] = 'elos_customize_comment_form';
}

function elos_customize_comment_form(&$form) {
  $form[LANGUAGE_NONE][0]['format']['#access'] = FALSE;
  return $form;
}

function elos_preprocess_page(&$vars) {
...
function elos_form_alter(&$form, &$form_state, $form_id) {
...
function elos_textarea($variables) {
...
function elos_breadcrumb($variables) {
	$crumbs ='';
...
//custom main menu
function elos_menu_tree__main_menu($variables) {
	$str = '';
